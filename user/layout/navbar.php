...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-white align-items-center fixed-top px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active me-2 js-scroll-trigger text-dark" href="dashboard.php"><strong>Home</strong></a>
                    </li>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" role="button">
                                    ...
                                    <span class="username"><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'User'; ?></span>
                                </a>
                            </li>
                            <small><p class="dropdown-item text-center"><i class="bi bi-clock-fill"></i> Pkl <?php echo date('H:i:s')?> WIB</p></small>
