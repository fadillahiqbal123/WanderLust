    ...
    <html lang="en">
        ...
        <body>
            <div class="row">
                <div class="col-lg-12 py-3 bg-ligth text-end bg-ligth fixed-top">
                <div class="dropdown">
            ...
            <div class="row mt-5 bg-body" style="padding-top: 20px;">
        <div class="col-lg-2 position-fixed vh-100 bg-ligth">
